...
function formatar(tarefas) {
  ...
  tarefas.forEach(function (tarefa) {
    ...
    dvLista.insertAdjacentHTML(
      'beforeend',
      `<li><div class="card">&nbsp;<strong>${titulo}</strong> - ${complemento}, criada por ${tarefa.autor.nome} ${tarefa.autor.sobrenome}</strong> e está na categoria ${tarefa.categoria}</div></li>`,
    );
  });
}
...
console.log(exportacaoDeTitulos(tarefas));

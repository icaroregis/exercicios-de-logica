class Passaporte {
  ...
  obterIniciais() {
    return `${this.nome[0].toUpperCase()}.${this.sobrenome[0].toUpperCase()}.`;
  }

  obterEhNomeValido() {
    let nomeValido = this.nome.length >= 1;
    let sobrenomeValido = this.sobrenome.length >= 1 && !this.sobrenome.endsWith('.');
